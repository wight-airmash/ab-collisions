...
/* harmony import */ var _Body_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
 ...
 * @class
 */
class Polygon extends _Body_mjs__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
	/**
	 * @constructor
...
/* harmony import */ var _Result_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _SAT_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
...
class Body {
  ...
  collides(target, result = null, aabb = true) {
    return Object(_SAT_mjs__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(this, target, result, aabb);
  }
   ...
   */
  createResult() {
    return new _Result_mjs__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]();
  }
 ...
 * @class
 */
class Circle extends _Body_mjs__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
	/**
	 * @constructor
	 * @param {Number} [x = 0] The starting X coordinate
	 * @param {Number} [y = 0] The starting Y coordinate
...
/* harmony import */ var _Polygon_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
 ...
 * @class
 */
class Point extends _Polygon_mjs__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
	/**
	 * @constructor
	 * @param {Number} [x = 0] The starting X coordinate
	 * @param {Number} [y = 0] The starting Y coordinate
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BVHBranch; });
/**
 * @private
 */
const branch_pool = [];
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BVH; });
/* harmony import */ var _BVHBranch_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
...
class BVH {
    ...
    if(!current) {
      ...
      while(true) {
        ...
        // Leaf
          ...
          const new_parent   = current._bvh_parent = body._bvh_parent = _BVHBranch_mjs__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].getBranch();
  ...
  remove(body, updating = false) {
    ...
    _BVHBranch_mjs__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].releaseBranch(parent);
  }
...
/* harmony import */ var _modules_BVH_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
/* harmony import */ var _modules_Circle_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Circle", function() { return _modules_Circle_mjs__WEBPACK_IMPORTED_MODULE_1__["a"]; });

/* harmony import */ var _modules_Polygon_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Polygon", function() { return _modules_Polygon_mjs__WEBPACK_IMPORTED_MODULE_2__["a"]; });

/* harmony import */ var _modules_Point_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Point", function() { return _modules_Point_mjs__WEBPACK_IMPORTED_MODULE_3__["a"]; });

/* harmony import */ var _modules_Result_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(0);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Result", function() { return _modules_Result_mjs__WEBPACK_IMPORTED_MODULE_4__["a"]; });

/* harmony import */ var _modules_SAT_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3);
...
class Collisions {
	...
	constructor() {
		/** @private */
		this._bvh = new _modules_BVH_mjs__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]();
	}
	...
	createCircle(x = 0, y = 0, radius = 0, scale = 1, padding = 0) {
		const body = new _modules_Circle_mjs__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"](x, y, radius, scale, padding);
	...
	createPolygon(x = 0, y = 0, points = [[0, 0]], angle = 0, scale_x = 1, scale_y = 1, padding = 0) {
		const body = new _modules_Polygon_mjs__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"](x, y, points, angle, scale_x, scale_y, padding);
	...
	createPoint(x = 0, y = 0, padding = 0) {
		const body = new _modules_Point_mjs__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"](x, y, padding);
	 ...
	 */
	createResult() {
		return new _modules_Result_mjs__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"]();
	}
	...
	collides(source, target, result = null, aabb = true) {
		return Object(_modules_SAT_mjs__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(source, target, result, aabb);
	}
};
